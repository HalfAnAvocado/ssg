...
data class Config(
    ...
    val fontsDirectory: PathAsString = Path("fonts"),
    val stylesheetsDirectory: PathAsString = Path("stylesheets"),
    val imagesDirectory: PathAsString = Path("images"),
    val faviconsDirectory: PathAsString = Path("favicons"),
    val configDirectory: PathAsString = Path("config"),
